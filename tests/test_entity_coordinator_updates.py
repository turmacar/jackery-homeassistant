...
class CoordinatorUpdateTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_select_en_routes_via_transfer_switch_command(self) -> None:
        ...
        api.async_set_device_property.assert_not_awaited()
        self.assertEqual(entity.current_option, "Scheduled Tasks")

    async def test_select_lm_routes_via_standard_property(self) -> None:
    ...
    async def test_number_pm_routes_via_standard_property(self) -> None:
